...
# Get a reference to tello cam 
class Tello:
    def __init__(self):
        self._running = True
        self.video = cv2.VideoCapture(0)#"udp://@0.0.0.0:11111"
    ...
    def recv(self):
        ...
        biden_image = face_recognition.load_image_file(cwd + "/biden.jpg")
                ...
                while True:
                    ...
                    if process_this_frame:
                        ...
                        for face_encoding in face_encodings:
                            ...
                            #print("Confidence value:", face_distances)
